...
const PhoneVerifyModal = ({ onClose, onVerified }) => {
  ...
  const getFullPhone = () => {
    ...
    if (!fullPhone.startsWith("+") && !fullPhone.startsWith("234")) {
      const cleanLocal = fullPhone.startsWith("0")
        ...
        <div style={{ padding: "26px" }}>
          ...
          {step === "phone" && (
            <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
              <p style={{ fontSize: 13.5, color: T.gray500, lineHeight: 1.7 }}>
                We'll send a 6-digit code to confirm this number. Standard SMS
                rates may apply.
              </p>
              ...
              <div>
                ...
                <div style={{ display: "flex", gap: 8 }}>
                  <select
                    ...
                    style={{ ...fs, width: 110, flexShrink: 0 }}
                  >
                    {COUNTRY_CODES.map((c) => (
              ...
              >
                <button
                  ...
                  style={{
                    ...
                    fontSize: 13,
                    fontWeight: 700,
                    color: canResend ? T.accent : T.gray500,
                    fontFamily: "'Inter',sans-serif",
                    padding: 0,
                  }}
                >
          ...
          {step === "done" && (
            <div style={{ textAlign: "center", padding: "16px 0" }}>
              ...
              >
                <span className="msym" style={{ fontSize: 32, color: T.green }}>
                  check_circle
                </span>
              </div>
              <div
              ...
              <div style={{ fontSize: 13.5, color: T.gray500 }}>
                {getFullPhone()} is now confirmed.
              </div>
            </div>
          )}
        </div>
