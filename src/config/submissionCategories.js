...
export const STANDARD_TWO_EVIDENCE_TYPES = Object.freeze([
  {
    ...
    type: "zip",
    source_type: "file",
    label: "1. Project Implementation Archive (ZIP File)",
    icon: "folder_zip",
  ...
  },
  {
    ...
    type: "link",
    source_type: "url",
    label: "2. Project Link (Figma, GitHub, Live Demo, etc.)",
    icon: "link",
    placeholder: "Paste Figma link, GitHub repository, live demo, or other project URL (e.g. https://...)",
    description: "External project link (e.g. Figma design, GitHub repository, live preview URL, or cloud deployment).",
    recommended: false,
    required: false,
  },
  {
    ...
    type: "documentation",
    source_type: "text",
    label: "3. Project Summary & Implementation Notes (Text Explanation)",
    icon: "description",
