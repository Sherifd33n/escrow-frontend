...
const Dashboard=({user,onLogout})=>{
  ...
  return(
    <div style={{background:"#f5f3f6",minHeight:"100dvh",paddingBottom:80}}>
      ...
      {showContract&&<ContractModal tx={showContract} scope={scope} user={user} onClose={()=>setShowContract(null)} onScopeUpdated={async (updatedTx)=>{ if (updatedTx) setShowContract(updatedTx); const res = await transactions.getAll(); if (res.data) setTxs(res.data); }}/>}
