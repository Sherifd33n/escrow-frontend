...
export default function ClientDashboard({
  ...
  const checkKYC = useCallback(async () => {
    try {
      ...
      if (data) {
        setKycStatus(data.govt_id_status || "none");
      }
    } catch {
      // ignore
    }
  ...
  const totalValue = activeTxs.reduce((s, t) => {
    ...
    const fundedM = (t.milestones || []).filter((m) =>
  ...
  const duePayments = payments.filter(
    (p) => p.status === "due" || p.milestones?.some((m) => m.status === "due"),
  ).length;
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            ...
            <span style={{ display: "none" }} id="svc-lbl">
              Services
            </span>
          </button>
          <button
          ...
          >
            ...
            <span style={{ display: "none" }} className="desk-only">
              Sign Out
            </span>
          </button>
          <button
      ...
      >
          ...
          <div>
            <div style={{ marginBottom: 20 }}>
              ...
              <p style={{ color: "#75777f", fontSize: 14 }}>
                Here's a summary of your escrow activity.
              </p>
            </div>
            {/* Stats */}
            <div
        ...
        {tab === "services" && (
          <div>
            <div style={{ marginBottom: 20 }}>
              ...
              <p style={{ color: "#75777f", fontSize: 14 }}>
                Browse and hire verified tech vendors — all payments protected
                by escrow.
              </p>
            </div>
        ...
        {tab === "transactions" && (
          <div>
            ...
            >
              ...
              <Btn variant="accent" onClick={() => setShowNew(true)}>
                <span className="msym" style={{ fontSize: 16 }}>
                  add
                </span>{" "}
                New Transaction
                            ...
                            <Btn
                              ...
                              onClick={(e) => {
                                ...
                                setShowRevisionInput(
                                  showRevisionInput === tx.id ? null : tx.id,
                                );
                              }}
                            >
                              <span className="msym" style={{ fontSize: 16 }}>
                          ...
                          {showRevisionInput === tx.id && (
                            ...
                            >
                              ...
                              <textarea
                                ...
                                onChange={(e) =>
                                  setRevisionDetails(e.target.value)
                                }
                                rows={3}
                                style={{
                                  width: "100%",
                                ...
                                <Btn
                                  ...
                                  onClick={async () => {
                                    if (!revisionDetails.trim()) {
                                      alert(
                                        "Please provide details for the revision request.",
                                      );
                                      return;
                                    }
                                    const submittedM = (
                                    ...
                                    if (submittedM) {
                                      ...
                                      res = await transactions.updateStatus(
                                        tx.realId,
                                        "revision",
                                        {
                                          reason:
        ...
        {tab === "kyc" && (
          ...
          >
            ...
            <p style={{ color: "#75777f", fontSize: 13.5, marginBottom: 20 }}>
              Verify your identity to unlock higher escrow limits and trust
              badges.
            </p>
            {[
              {
        ...
        {tab === "disputes" && (
          ...
          >
            ...
            <p style={{ color: "#75777f", fontSize: 13.5, marginBottom: 20 }}>
              AI-assisted resolution with binding arbitration.
            </p>
                ...
                .map((tx) => (
                  ...
                  >
                    <div>
                      ...
                      <div style={{ fontSize: 12.5, color: "#75777f" }}>
                        {tx.id} · ${tx.amount.toLocaleString()} · {tx.other}
                      </div>
                    </div>
                    <Btn
                      variant="red"
      ...
      {showNew && (
        ...
        >
          ...
          >
            <div
              style={{
                background: "linear-gradient(135deg,#001637,#172b4d)",
                padding: "18px 20px",
                color: "#fff",
                position: "sticky",
                top: 0,
                ...
                {[1, 2, 3].map((n) => (
                  <div
                    ...
                    style={{
                      ...
                      height: 3,
                      borderRadius: 2,
                      background: ns >= n ? "#0ea5e9" : "rgba(255,255,255,.18)",
            ...
            <div style={{ padding: "18px 16px" }}>
                    ...
                    >
                      {CATS.map((c) => (
                        <button
                          ...
                          style={{
                            border: `1.5px solid ${nf.type === c.id ? c.color : "#e4e2e5"}`,
                            borderRadius: 8,
                            padding: "7px 3px",
                            cursor: "pointer",
                            textAlign: "center",
                            background:
                              nf.type === c.id ? c.color + "12" : "#fff",
                            transition: "all .15s",
                          }}
                        >
                          <div
                            style={{
                              fontSize: 8.5,
                              fontWeight: 600,
                              color: nf.type === c.id ? c.color : "#75777f",
                            }}
                          >
                            {c.label}
                          </div>
              ...
              {ns === 2 && (
                <div
                  style={{ display: "flex", flexDirection: "column", gap: 14 }}
                >
                  <F label="Vendor/Provider Email" req>
                    <input
                      style={fs}
                      type="email"
                  ...
                  >
                    The vendor will receive an email invitation to join this
                    transaction.
                  </div>
                </div>
              )}
      ...
      {showContract && (
        <ContractModal
          tx={showContract}
          scope={showContract?.scope_json || scope}
          user={user}
